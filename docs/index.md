...
<div class="home-hero">
  ...
  <div class="home-hero-tagline">🌻 暖心攻略 · 实用工具 · 田园游戏百科全书</div>
...
<div class="game-card-title"><a href="stardew/" class="game-card-title-link">🌟 Stardew Valley</a></div>
...
<div class="game-hero-card game-card-farmsim" data-href="farmingsim/" onclick="gameCardClick(event, 'farmingsim/')">
<div class="game-hero-card-inner">
<div class="game-card-title"><a href="farmingsim/" class="game-card-title-link">🚜 Farming Simulator 25</a></div>
...
<div class="game-card-links">
  ...
  <a href="farmingsim/profit-guide/" class="game-card-link">💰 Profit Guide</a>
  <a href="farmingsim/production-chains/" class="game-card-link">🏭 Production</a>
</div>
</div>
</div>

<div class="game-hero-card game-card-palia" data-href="palia/" onclick="gameCardClick(event, 'palia/')">
<div class="game-hero-card-inner">
<div class="game-card-title"><a href="palia/" class="game-card-title-link">🏹 Palia</a></div>
<div class="game-card-sub">🏹 MMO Cozy</div>
<p>Cozy MMO guide — beginner tips, quests, relationships, farming, cooking, and more.</p>
<div class="game-card-links">
  <a href="palia/" class="game-card-link">📖 Full Guide</a>
  <a href="palia/guide/" class="game-card-link">👶 Beginner</a>
  <a href="palia/crops/" class="game-card-link">🌱 Crops</a>
  <a href="palia/fish/" class="game-card-link">🐟 Fish</a>
  <a href="palia/cooking/" class="game-card-link">🍳 Cooking</a>
  <a href="palia/friendship/" class="game-card-link">💝 Friendship</a>
</div>
</div>
</div>
...
<div class="game-card-links">
  ...
  <a href="fields-mistria/fish/" class="game-card-link">🐟 Fish</a>
  <a href="fields-mistria/gift-guide/" class="game-card-link">💝 Gifts</a>
</div>
</div>
</div>

<div class="game-hero-card game-card-coral" data-href="coral-island/" onclick="gameCardClick(event, 'coral-island/')">
<div class="game-hero-card-inner">
<div class="game-card-title"><a href="coral-island/" class="game-card-title-link">🏝️ Coral Island</a></div>
<div class="game-card-sub">🏝️ Tropical Farm</div>
<p>Crops, diving, mining, romance, artisan goods, and island life essentials.</p>
<div class="game-card-links">
  <a href="coral-island/" class="game-card-link">📖 Full Guide</a>
  <a href="coral-island/getting-started/" class="game-card-link">👶 Beginner</a>
  <a href="coral-island/crops/" class="game-card-link">🌱 Crops</a>
  <a href="coral-island/diving/" class="game-card-link">🤿 Diving</a>
  <a href="coral-island/mining/" class="game-card-link">⛏️ Mining</a>
  <a href="coral-island/romance/" class="game-card-link">💕 Romance</a>
</div>
</div>
</div>

<div class="game-hero-card game-card-sandrock" data-href="sandrock/" onclick="gameCardClick(event, 'sandrock/')">
<div class="game-hero-card-inner">
<div class="game-card-title"><a href="sandrock/" class="game-card-title-link">🏜️ My Time at Sandrock</a></div>
<div class="game-card-sub">🏜️ Post-Apo Builder</div>
<p>Resources, crops, combat, workshop optimization, cooking, and seasonal guides.</p>
<div class="game-card-links">
  <a href="sandrock/" class="game-card-link">📖 Full Guide</a>
  <a href="sandrock/getting-started/" class="game-card-link">👶 Beginner</a>
  <a href="sandrock/crops/" class="game-card-link">🌱 Crops</a>
  <a href="sandrock/workshop-optimization/" class="game-card-link">🔧 Workshop</a>
  <a href="sandrock/cooking/" class="game-card-link">🍳 Cooking</a>
  <a href="sandrock/animals/" class="game-card-link">🐪 Animals</a>
</div>
</div>
</div>

<div class="game-hero-card game-card-sunhaven" data-href="sun-haven/" onclick="gameCardClick(event, 'sun-haven/')">
<div class="game-hero-card-inner">
<div class="game-card-title"><a href="sun-haven/" class="game-card-title-link">🌞 Sun Haven</a></div>
<div class="game-card-sub">🌞 Fantasy Farm</div>
<p>Crop profits, combat & magic, fishing, animals, festivals, and NPC gifts.</p>
<div class="game-card-links">
  <a href="sun-haven/" class="game-card-link">📖 Full Guide</a>
  <a href="sun-haven/getting-started/" class="game-card-link">👶 Beginner</a>
  <a href="sun-haven/crop-profit/" class="game-card-link">🌱 Crops</a>
  <a href="sun-haven/combat/" class="game-card-link">⚔️ Combat</a>
  <a href="sun-haven/fishing/" class="game-card-link">🐟 Fishing</a>
  <a href="sun-haven/npc-gifts/" class="game-card-link">🎁 Gifts</a>
</div>
</div>
</div>

<div class="game-hero-card game-card-ranch" data-href="tools/game-comparison/" onclick="gameCardClick(event, 'tools/game-comparison/')">
<div class="game-hero-card-inner">
<div class="game-card-title"><a href="tools/game-comparison/" class="game-card-title-link">🦌 Ranch Simulator</a></div>
<div class="game-card-sub">🦌 Open World Ranch</div>
<p>Build, ranch, hunt, and explore in this open-world farming simulation adventure.</p>
<div class="game-card-links">
...
<div class="game-hero-card game-card-ancient" data-href="ancient-farm/" onclick="gameCardClick(event, 'ancient-farm/')">
<div class="game-hero-card-inner">
<div class="game-card-title"><a href="ancient-farm/" class="game-card-title-link">🏺 Ancient Farm</a></div>
<div class="game-card-sub">🏺 Ancient Egypt · Zero Automation</div>
<p>A2 Softworks' Nile-set farming sim — no sprinklers, no tractors. Hand-craft every tool, ride an ox to plow, and survive the withering Shemu season.</p>
<div class="game-card-links">
  <a href="ancient-farm/" class="game-card-link">📖 Full Guide</a>
  <a href="ancient-farm/beginners-guide/" class="game-card-link">🌱 Beginner's Guide</a>
</div>
</div>
</div>
...
<p>BotanX's 89%-rated folklore farming sim — a hidden Peach Blossom Spring village where everything trades by value. Panda mounts, martial arts, and weddings included.</p>
<div class="game-card-links">
...
<div class="game-card-sub">⚰️ Cozy Horror · Coming Fall 2026</div>
<p>Perfect Garbage × Blumhouse Games' farming sim where a supernatural serial killer hides among your 30+ neighbors. Farm by day, unmask the killer by night — one in-game year to solve it. Delayed from August 14 to Fall 2026.</p>
<div class="game-card-links">
  <a href="grave-seasons/" class="game-card-link">📖 Full Guide</a>
  <a href="grave-seasons/beginners-guide/" class="game-card-link">🕵️ Preview Guide</a>
</div>
</div>
</div>
...
<a href="tools/" class="home-view-all">View all tools →</a>
...
<div class="article-preview-card">
  ...
  <div class="article-body-home">
    ...
    <p>The complete fishing compendium for Tales of Seikyu: all 37 fish by season and location, best casting spots from the town square river to the open ocean, rod upgrades and bait progression, the Kappa yokai form connection, and pro tips for shrine offerings.</p>
...
<div class="video-series-card">
  ...
  <div class="video-series-progress-grid">
    ...
    <div class="video-series-progress-item">
      <div class="vsp-top">
        ...
        <span class="vsp-status vsp-complete">2 / 2 ✅</span>
      </div>
      <div class="vsp-bar"><div class="vsp-fill" style="width:100%"></div></div>
      <span class="vsp-label">已完成</span>
    </div>
  ...
  <div class="video-series-footer">
    <div class="video-series-footer-left">
      <span class="video-series-total">📊 <strong>5个系列</strong> · <strong>13篇攻略</strong> 计划 · <strong>11</strong> 已上线</span>
    </div>
    <div class="video-series-footer-right">
      <span class="video-series-next">📅 下篇: <strong>【星露谷物语】哄 堂 大 孝</strong></span>
...
<div class="about-section-home">
  <h3>🌾 About Farming Games Help</h3>
  <p>Data-driven game guides, interactive calculators, and curated databases for cozy farming games — Stardew Valley, Palia, Coral Island, and more. Every guide is play-tested. Updated weekly. Always free.</p>
...
<script>
function gameCardClick(event, url) {
