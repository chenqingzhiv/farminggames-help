...
> **Stardew Valley** is a classic farm-life RPG. This guide hub collects everything from beginner basics to full achievement completion, covering all new 1.6 content.

*Data source: Stardew Valley Wiki v1.6 | Continuously updated*

---

## 📋 Guide Index

This guide hub contains **30+ guide pages**, organized by category. Click any page name to jump there.
...
## 🆕 1.6 Update Quick Overview

| Feature | Description |
|:-----|:------|
| 🪄 **New Skill Books** | New Meadowlands Farm, skill books now push past level 10 cap |
| 🎀 **Trinket System** | New trinket equipment slot with rare enemy drops |
| 🐸 **Frog Companions** | Collectible frog companions in multiple colors |
| 🛠️ **Mastery System** | Mastery system unlocked when all 5 skills hit level 10 |
| 🌿 **New Crops** | Carrot, Summer Squash, Broccoli, Powdermelon, and more |
| 🏠 **New Furniture & Decor** | New furniture sets, movable bed placement |

> See the [1.6 Update Guide](1.6-update-guide/) for full details
