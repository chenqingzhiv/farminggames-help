---
title: "Starsand Island Base Building & Home Design Guide — Land Expansion, Build Mode, Farm Structures & Decor (2026 EA)"
description: "Complete Starsand Island base building and home design guide for 2026. How to unlock land expansion, every Hopeland plot cost, the four homestead properties, Build Mode controls, farm structures and Worktable tiers, the Greenhouse and World Tree, blueprints, and optimal farm layouts."
date: 2026-08-05
---
...
After 90+ hours with Starsand Island (星砂岛), I can tell you the building system is the sleeper hit of the game. The farming, fishing, and mining guides I wrote earlier cover the *income* side — but this is the guide for the *spending* side. There are nearly **1,000 placeable items**, **4 buildable properties**, **8 land expansion plots**, a **Blueprint Library** for sharing designs, and a paint system that lets you restyle every wall, floor, and roof you place. It is genuinely one of the deepest building systems in any farming sim this year.

The catch: almost none of it is handed to you. Land expansion is locked behind a five-step quest chain, the greenhouse costs 55,000g, and the best properties sit behind endgame titles. This guide walks the whole progression — from your first night in the starter cottage to the private island endgame — and shows you the layouts that actually work.

*Data sourced from in-game testing, the official Chinese strategy handbook (Bilibili Wiki), and community research. Prices in in-game gold (g) and Starsand (星砂币). Starsand is the premium currency earned from StarNote level rewards and Island Life goals — see the Crop Profit Guide for the full income list. Verified for EA version 0.4.x. Where community sources disagree on numbers, I flag both and note what to check in-game.*
...
![Starsand Island Hopeland starting homestead overview showing the starter cottage, mailbox, shipping bin and farm swing](images/building-homestead.webp)
...
2. **Use the farm swing** for free stamina recovery instead of spending gold on food in week one.
3. **Repair the Damaged Door as soon as you can.** It is unlocked through the Exploration Club tutorial quest from Zephyria (岚) — craft a Slingshot and break the door down. Behind it is the Moonlit Forest (荧月之森), where iron, copper, gold, quartz, and every advanced building material live.
...
| 4 | **First Pot of Gold** | Accumulate 2,000g **and** meet 10 Islanders |
...
| Plot | Gold (g) | Starsand | Value Verdict |
|:----:|:---------:|:--------:|:-----------------------:|
...
> 💡 **Buy Plots 1–2 immediately.** At 2,000g + 15,000g and 125 Starsand combined, they more than double your buildable area for pocket change — and they unlock long before you will earn real money. Hold Plots 5–8 until you have **Sprinkler II+ and a stable income loop** (the fishing and crop guides cover both).
...
![Starsand Island four homestead properties diagram comparing Hopeland, Cloudrest Lake, Blue Beach and Windflute Island](images/building-properties.webp)

| Property | Unlock Title | Cost | Why You Want It |
|:---------|:-------------|:-----|:----------------|
| **Hopeland (启程之地)** | Starting property | Free | Central base; crops + first home |
| **Cloudrest Lake (栖云湖)** | Home Builder rank | 6,000,000g + 750 Starsand | Lakeside property ideal for **ranching** — has a fishable lake, bamboo groves, beehives, and a panda NPC |
...
**How titles rank up:** titles come from Island Life progression, not a single checklist. **Home Builder** is the first building title you will realistically hit (tied to expanding Hopeland and placing structures); **Bright Star** and **Starsand Legend** are deep endgame grinds.

> 📌 **Price caveat:** the **Cloudrest Lake** figure (6,000,000g + 750 Starsand) is community-sourced, not officially confirmed — treat it as a ballpark like the Blue Beach and Windflute costs above. The land expansion plot prices earlier are the only figures verified against multiple updated sources.

> 💡 **Divide the labor across properties.** The community consensus: keep **Hopeland as your crop-and-crafting hub**, move **ranching to Cloudrest Lake** (the pasture is bigger and the lake gives you a second fishing spot), and treat **Blue Beach / Windflute** as seasonal or collection properties once you can afford them. Because each property is independent, you do not have to tear down anything to start fresh somewhere else.
...
> 💡 **Blueprint before you build big.** If you are about to lay out a multi-room house, save a blank blueprint of the plot first so you can experiment without risk. Loading a blueprint *replaces everything on your land*, so never load one over a design you love without backing it up.
...
**The Moonlit Forest is the keystone.** Nearly every advanced material — ore, quartz, and the rarer building components — lives there, and you can only reach it by repairing the Damaged Door (the Exploration Club tutorial quest from Zephyria (岚), then a Slingshot). If you find yourself blocked on a build recipe, the missing ingredient is almost always an ore or processed wood from the forest.

> ⚠️ **Do not sell your first ores.** The mining guide covers this, but it bears repeating for builders: copper, iron, and gold ingots plus premium wood planks are consumed in huge quantities by Worktable II and III recipes. Stockpile before you spend.
...
| **Greenhouse** | Expert Farmer + 55,000g from Graminova | **Year-round crops regardless of season**; expandable with the Copy feature; Sprinkler II/III work inside |
...
![Starsand Island greenhouse unlock diagram showing the Expert Farmer requirement and 55,000g cost](images/building-greenhouse.webp)

The Greenhouse (温室) is the single most valuable farm structure in the game. Unlock requires **Expert Farmer** — the fifth and final Farmer tier — and then **55,000g** for the manual from Graminova (顾禾) at the Happiness Seed Shop. Inside, **seasonal restrictions disappear**: spring-only strawberries grow in winter, and off-season fruit trees keep producing. Pair it with the **Starsand Grinder** and you get a self-sustaining seed-replant-sell loop that runs year-round.
...
The **World Tree** is a special structure crafted at **Worktable III**. Plant it on your farm and it **generates a daily treasure chest** with random rewards — gold, Starsand, materials, and occasionally rare items.

![Starsand Island World Tree passive income concept showing the daily treasure chest cycle](images/building-world-tree.webp)
...
- It is the community's single most recommended Worktable III build — build it the moment you hit tier III.
...
1. **Check the plot space and unlock requirements first.** Some players bought layouts they could not place because the plot was too small.
...
5. **Place trellises on untilled ground.** Tilling first can bug out tiles so they cannot be replanted.
...
- **Buy Plots 1–2 immediately.** 2,000g + 15,000g more than doubles your buildable space for pocket change.
...
- **Place the World Tree the day you hit Worktable III.** It is the best passive income in the game.
- **Save blueprints before loading community designs.** Loading a layout replaces everything on your land.
- **Use the paint system to zone rooms.** It is free and makes layouts instantly readable.
- **Open Buy Land with the phone app and read plot costs twice.** No refunds.

### ❌ Do Not Do This

- **Buy all 8 plots early.** The back-half plots cost 100k+ gold each and do nothing until you build on them.
...
- **Buy a preset layout without checking plot size.** Some layouts will not fit your current plot.
...
Complete the five Island Life challenges in order — Long Time No See, Apprentice Talent, Decorate Your Home (6 furniture), First Pot of Gold (2,000g + 10 Islanders), and Junior Talent (Junior rank + 5 Bulletin Board requests). Then the Buy Land app appears on your phone.

### How much does all of Hopeland cost?
All 8 expansion plots total **562,000g + 1,255 Starsand**. Some community sources list lower mid-tier costs, so verify the in-game price before buying.
...
### What is the best farm structure in the game?
The **Greenhouse** (55,000g, Expert Farmer) for year-round crops, and the **World Tree** (Worktable III) for daily passive income. Build both as soon as you can.
